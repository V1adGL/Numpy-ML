...
# Ансамблевые методы. В основе идея объединения нескольких переобученных (!) моделей для уменьшения
# эффекта переобучения. Эта процедура называется баггинг (bagging).
