...
# набор правил, которые позволяют осуществлять бинарные
...
#
# print(a + b)
# print(a + 5)   # Рассматривается как команда - сложить 2 массива разных форм,
# # в результате чего "5" транслируется (представляется) как [5, 5, 5]
#
...
# 2. Если формы массивов не совпадают в каком-то измерении, то если у массива
# форма равна 1, то он "растягивается" до соответствия формы второго массива
